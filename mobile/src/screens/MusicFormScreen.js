...
const MusicFormScreen = () => {
  ...
  const insertMusic = async () => {
    ...
    await axios.post(MUSIC_API_URL, {
      name: name,
      file: fileInfo
    }, {
      headers: {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <Button title="Insert" onPress={() => { insertMusic() }} />
      </View>
          ...
          return (
            <View style={styles.music}>
              ...
              <View style={styles.musicActions}>
                <Button title="Play" onPress={() => { playMusic(item.id) }} />
                <Button title="Delete" color="red" onPress={() => { deleteMusic(item.id) }} />
              </View>
            </View>
          )
        }}
